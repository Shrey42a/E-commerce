...
function About() {
    ...
    <>
      <div className="flex justify-center bg-center gradient4 h-max lg:h-screen items-top lg:items-center">
        <div className="flex flex-col w-full p-2 my-20 lg:w-4/5 h-1/2 lg:h-max lg:my-0 lg:flex-row bg10">
            <div className="flex flex-col w-full h-full lg:w-1/2">
              ...
              <div className="flex items-center justify-center w-full h-24 lg:h-20">
